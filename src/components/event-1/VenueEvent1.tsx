...
import AddToCalendarEvent1 from "./AddToCalendarEvent1";
import ExpectedAttendenceEvent1 from "./ExpectedAttendenceEvent1";
import Anchor from "../map/Anchor";
import { MapProvider, useMap } from "../map/MapProvider";
import UniMap from "../map/UniMap";

const VenueEvent1: FC = () => {
  return (
